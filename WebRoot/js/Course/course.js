...
$(function() {
	...
	$.getJSON('./servlet/QueryCourseByCourseNumServlet',{
		...
		$('#c1').attr( 'href' , '/micromatch/jsp/Course/courseInfo.jsp?CourseNum=' + CourseNum ) ;
		$('#c2').attr( 'href' , '/micromatch/jsp/Course/courseInfo.jsp?CourseNum=' + CourseNum ) ;
		$('#c3').attr( 'href' , '/micromatch/jsp/Course/courseInfo.jsp?CourseNum=' + CourseNum ) ;
		...
		if( json.Period != 0 ){	
			$.getJSON('./servlet/QueryChapterByCourseNumServlet',{
				...
				$.getJSON( './servlet/showChooseChapterServlet',{
					...
					$('#cha1').attr( 'href' , '/micromatch/jsp/Course/course.jsp?CourseNum=' + CourseNum + '&ListId=' + listId ) ;
					$('#cha2').attr( 'href' , '/micromatch/jsp/Course/course.jsp?CourseNum=' + CourseNum + '&ListId=' + listId ) ;
