...
public class PublishMatchServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String matchName = new String(request.getParameter("MatchName") ) ;
		String matchContent = new String(request.getParameter("MatchContent") ) ;
		String matchStartTime = request.getParameter("StartTime") ;
		String matchEndTime = request.getParameter("EndTime") ;
		String matchPicture = request.getParameter( "MatchPic" ) ;
