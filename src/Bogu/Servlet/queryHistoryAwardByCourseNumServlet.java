...
public class queryHistoryAwardByCourseNumServlet extends HttpServlet {
	 ...
	 */
	public queryHistoryAwardByCourseNumServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray json = bllInterface.queryHistoryAward( courseNum ) ;
