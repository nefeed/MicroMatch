...
public class QueryMatchByUserNumServlet extends HttpServlet {
	 ...
	 */
	public QueryMatchByUserNumServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray jsonArray = bllInterface.QueryMatchByUserNum( userNum ) ;
		out.print( jsonArray ) ;
		out.flush();
		out.close();
	}
