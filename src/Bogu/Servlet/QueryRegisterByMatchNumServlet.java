...
public class QueryRegisterByMatchNumServlet extends HttpServlet {
	 ...
	 */
	public QueryRegisterByMatchNumServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		m.setMatchTemp(matchTemp);
		JSONArray jsonArray =  bllInterface.QueryRegisterByMatchNum( m ) ;
		out.print( jsonArray ) ;
		out.flush();
		out.close();
	}
