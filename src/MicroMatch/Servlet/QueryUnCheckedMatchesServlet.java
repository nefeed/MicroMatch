...
public class QueryUnCheckedMatchesServlet extends HttpServlet {
	 ...
	 */
	public QueryUnCheckedMatchesServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray jsonArray = bllInterface.QueryUncheckedMatches(check) ;
		out.print( jsonArray ) ;
		out.flush();
		out.close();
	}
