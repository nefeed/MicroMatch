...
public class AddChapterServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if ( !bllInterface.isMyCourse( c ) ) {
			...
			String name = ConvertCharSet.toUTF8( request.getParameter("ChapterName") ) ;
			String content = ConvertCharSet.toUTF8( request.getParameter("ChapterContent") ) ;
			String fileAddress = ConvertCharSet.toUTF8( request.getParameter( "VideoAddress" ) ) ;
			String videoName = ConvertCharSet.toUTF8( request.getParameter( "VideoName" ) ) ;
			...
			chapter.setChapterVideoName( videoName ) ;
