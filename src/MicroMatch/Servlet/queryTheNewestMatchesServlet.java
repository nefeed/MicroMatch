...
public class queryTheNewestMatchesServlet extends HttpServlet {
	 ...
	 */
	public queryTheNewestMatchesServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Integer indexNum = Integer.parseInt( request.getParameter( "IndexNum" ) ) ;
		
		JSONArray jsonArray = bllInterface.queryTheNewestMatches( indexNum ) ;
