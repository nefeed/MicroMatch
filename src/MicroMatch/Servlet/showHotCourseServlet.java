...
public class showHotCourseServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Integer listNum = Integer.parseInt( request.getParameter("ListNum").toString() ) ;
		
		JSONArray json = bllInterface.showHotCourse( listNum ) ;
		out.print( json ) ;
		out.flush();
		out.close();
	}
